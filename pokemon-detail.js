...
async function loadPokemon(id) {
  try {
    ...
    console.error("An error occured while loading Pokemon data:", error);
    return false;
  }
}
...
function setTypeBackgroundColor(pokemon) {
  ...
  if (!color) {
    console.warn(`Color for type ${mainType} is not defined`);
    return;
  }
  ...
  setElementStyles(
    document.querySelectorAll(".stats-wrap > p.progress-bar"),
    "color",
    color
  );
